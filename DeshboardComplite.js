    ...
    <div className="dashboard-section section-pading">
      <div className="container">
        ...
        <div className="row">
          ...
          <div className="col-md-6">
            <div className="team_regi team_regi-right speace">
              <div className="reg_comp_icon">
                <img src="/img/regicom.png" />
              </div>
              <div className="added__successfull">
                <p>member added successfully</p>
              </div>
              <div className="add_another_member">
                <div className="row">
                  <div className="col-md-6">
              ...
              <div className="row">
                <div className="col-md-12 mb-4">
                  <span className="btn team_regi-right__btn">Edit Member</span>
                </div>
                <div className="col-md-12 text-center">
                  <span className="combtn narow">
                    Complete Team Regestration
                  </span>
                </div>
              </div>
            </div>
...
export default DeshboardComplite;
